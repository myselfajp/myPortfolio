      ...
      <div className="relative max-w-xl w-full mx-auto flex items-start flex-col gap-2">
        <div className="relative max-w-xl w-full mx-auto">
          <Textarea
            ...
            className={cn(
              "max-w-xl bg-transparent w-full rounded-3xl pl-6 pr-10 py-4",
              "placeholder:text-black/70 dark:placeholder:text-white/70",
              "border border-white/15 bg-black/30 dark:bg-white/5 backdrop-blur-sm",
          ...
          <button
            ...
            className={cn(
              "absolute right-3 top-1/2 -translate-y-1/2 rounded-xl py-1 px-1 transition",
              submitted
                ? "bg-none opacity-80"
